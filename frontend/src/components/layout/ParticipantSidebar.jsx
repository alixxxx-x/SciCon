...
const navMain = [
    {
        title: "Main",
        items: [
            { title: "Dashboard", url: "/dashboard-participant", icon: LayoutDashboard },
            { title: "Events", url: "/events", icon: Calendar },
            { title: "Registrations", url: "/dashboard-participant?tab=registrations", icon: FileText },
            { title: "Certificates", url: "/dashboard-participant?tab=certificates", icon: Award },
        ]
    },
    {
        title: "Account",

                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                className="w-full bg-[#0a0a0a] border border-gray-800 text-white text-sm rounded-xl px-4 py-3.5 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all placeholder:text-gray-700 font-medium"
                                type="email"
                                value={email}

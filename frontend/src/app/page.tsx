...
export default function HomePage() {
  ...
  // Effect 1: Rotate the text every 3 seconds
  useEffect(() => {
  ...
  // Effect 2: Update countdown timer every second
  useEffect(() => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Contact us at info@events.dz with your event details to get listed on our platform.",
    },
  ]
  ...
  const handleNewsletterSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    alert("Thank you for subscribing to events.dz!")
    setEmail("")
  }
    ...
    <div className="homepage">
      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          <div className="hero-text-container">
            <h1 className="hero-main-title">events.dz</h1>
      ...
      <section className="stats-section">
        <div className="stats-container">
          <h2 className="section-title">Why events.dz?</h2>
          ...
          <div className="stats-grid">
            ...
            <div>
              <img
                src=" algeria-doctors-meeting.jpg"
                alt="Algerian medical professionals networking"
      ...
      <section className="speakers-section">
        <div className="speakers-background">
          <img src="algeria medical background.jpg" alt="Algerian medical event" />
        </div>
